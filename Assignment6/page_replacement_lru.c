...
int latest_page_location(int page, int frame_size)
{

    /*
     *  Input   :   Page ID, frame size
     *  Utility :   Find latest location of page in buffer.
     *  Output  :   Location
     */
    int location = -1, i;
    for(i = 0; i < frame_size; i++)
    {
        if(frame_buffer[i] == page)
        {
            location = i;
        }
    }
...
void page_replacement_algorithm(int frame_size, int input_size)
{
    ...
    for(i = 0; i < input_size; i++)
    {
        ...
        else
        {
            ...
            {
                index = latest_page_location(input_string[i - frame_size], frame_size);
            }
...
Replacing oldest frame in buffer at location (1) with page 4
Contents of Frame Buffer : 
1
4
3
...
Page not found in buffer (miss)
Page 6 placed at location 1
Replacing oldest frame in buffer at location (0) with page 6
Contents of Frame Buffer : 
1
4
6
...
Page not found in buffer (miss)
Page 4 placed at location 1
Replacing oldest frame in buffer at location (2) with page 4
Contents of Frame Buffer : 
4
2
6
...
Replacing oldest frame in buffer at location (0) with page 1
Contents of Frame Buffer : 
4
2
1
...
Page not found in buffer (miss)
Page 5 placed at location 0
Replacing oldest frame in buffer at location (1) with page 5
Contents of Frame Buffer : 
4
5
1
...
Replacing oldest frame in buffer at location (0) with page 2
Contents of Frame Buffer : 
4
5
2
...
Page not found in buffer (miss)
Page 3 placed at location 2
Replacing oldest frame in buffer at location (1) with page 3
Contents of Frame Buffer : 
1
3
2
